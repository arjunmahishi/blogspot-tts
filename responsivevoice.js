                ...
                : setTimeout(function() {
                    var b = setInterval(function() {
                        ...
                        0 != c.length || null != a.systemvoices && 0 != a.systemvoices.length
                            ...
                            : (console.log("Voice support NOT ready"), a.voicesupport_attempts++, a.voicesupport_attempts > a.VOICESUPPORT_ATTEMPTLIMIT && (clearInterval(b), null != window.speechSynthesis
                                ? a.iOS
                                    ? (a.iOS9
                                        ? a.systemVoicesReady(a.cache_ios9_voices)
                                        : a.systemVoicesReady(a.cache_ios_voices), console.log("RV: Voice support ready (cached)"))
...
- 1 == g && -1 == f.search(" ") && (g = 99);
                ...
                for (g = 0; g < h.length; g++)
                    if (a.fallbackMode) {
                        ...
                        var d = a.selectBest([f.collectionvoice.pitch, f.systemvoice.pitch, 1]),
                            ...
                            m;
                        null != e && (d *= null != e.pitch
                            ? e.pitch
                            : 1, k *= null != e.rate
                            ? e.rate
                            : 1, l *= null != e.volume
                            ? e.volume
                            : 1, m = e.extraParams || null);
                        d /= 2;
                        k /= 2;
                        l *= 2;
                    ...
                    null != e
                        ? (d.voice = "undefined" !== typeof e.voice
                            ? e.voice
                            : f.systemvoice, g < h.length - 1 && 1 < h.length
                            ? (d.onend = a.onPartEnd, d.hasOwnProperty("addEventListener") && d.addEventListener("end", a.onPartEnd))
                            : (d.onend = a.speech_onend, d.hasOwnProperty("addEventListener") && d.addEventListener("end", a.speech_onend)), d.onerror = e.onerror || function(b) {
                        ...
                        d.rate = a.iOS
                            ...
                            : (null != e.rate
                                ? e.rate
                                : 1) * d.rate,
                        d.volume = null != e.volume
                            ? e.volume
                            : d.volume)
                        : (a.log("No Params received for current Utterance"), d.voice = f.systemvoice, d.onend = a.speech_onend, d.onboundary = a.onboundary, d.onerror = function(b) {
                            a.log("RV: Unknow Error");
                            a.log(b)
                        }),
                    a.utterances.push(d),
        ...
        a.speech_onend = function() {
            ...
            !0 === a.cancelled
                ? a.cancelled = !1
                : (a.log("on end fired"), null != a.msgparameters && null != a.msgparameters.onend && 1 != a.msgparameters.onendcalled && (a.log("Speech on end called  -" + a.msgtext), a.msgparameters.onendcalled = !0, a.msgparameters.onend()))
        };
        ...
        a.fallback_finishPart = function(b) {
            a.isFallbackAudioPlaying()
                ...
                : (a.checkAndCancelTimeout(), a.fallback_part_index < a.fallback_parts.length - 1
        ...
        a.getResponsiveVoice = function(b) {
            for (var c = 0; c < a.responsivevoices.length; c++)
                if (a.responsivevoices[c].name == b)
                    return !0 === a.responsivevoices[c].mappedProfile.collectionvoice.fallbackvoice || !0 === a.fallbackMode
